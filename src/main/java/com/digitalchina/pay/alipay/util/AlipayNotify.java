package com.digitalchina.pay.alipay.util;
...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String partnerId) {
...
//        }
        try {
            isSign = AlipaySignature.rsaCheck(preSignStr,sign,AlipayConfig.ali_public_key, AlipayConfig.input_charset,signType);
